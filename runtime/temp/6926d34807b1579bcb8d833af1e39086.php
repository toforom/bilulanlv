<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"/www/wwwroot/bilulanlv/application/admin20161108/view/diary/index.html";i:1496111977;}*/ ?>
<!DOCTYPE html>
<html>
						...
						<div class="ibox-content">
							...
							<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
								<div class="row">
									...
									<form name="formso" method="post" action="<?php echo url('diary/so'); ?>" onsubmit="return searcheck();">
								...
								<table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
									...
									<tbody>
										<tr class="gradeA odd">
											...
											<td class=""><strong><a href="<?php echo url('index/DiaryPage/index','id='.$vo['id']); ?>" target="_blank"><?php echo $vo['title']; ?></a></strong></td>
											...
											<td class="" ><a href="<?php echo url('diarychange/index','id='.$vo['id']); ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-trash" id="<?php echo $vo['id']; ?>" onclick="deleajax(this.id)" style="cursor:pointer;"></span></td>
										</tr>
									</tbody>
...
function showajax(id){
		//AJAX提交
				$.ajax({
					type:"post",
					url:'<?php echo url('./admin20161108/diary/show','','',true); ?>',
					data:{id:id},
					datatype:'json',
...
layer.confirm('确定删除该记录,此操作不可逆？', {
  btn: ['坚决要删除','再想想'] //按钮
  	...
  	//AJAX提交删除
				$.ajax({
					type:"post",
					url:'<?php echo url('./admin20161108/diary/dele','','',true); ?>',
					data:{id:id},
					datatype:'json',
					success:function(data){
						if(data.code==0){
