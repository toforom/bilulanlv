<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"E:\WWW\bilulanlv\public/../application/index\view\diary\index.html";i:1497880342;s:65:"E:\WWW\bilulanlv\public/../application/index\view\left\index.html";i:1497880343;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">

	<head>
		<title>絮语--记录筚路蓝缕创业生活的个人博客网站！</title>
		<meta name="keywords" content="个人博客,深蓝个人博客,个人博客模板,原创博客,技术搏客,筚路蓝缕,以启山林,毕路蓝褛,毕路蓝缕" />
		<meta name="description" content="深蓝个人博客,是一个记录筚路蓝缕,以启山林的创业生活,分享生活点滴,坚持做原创个人博客网站。" />
...
(function(){
    ...
    s.parentNode.insertBefore(bp, s);
				...
				<div class="xs5 height-big" id="layer-photos-demo">
					<?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<div class="margin-large-top ">
							<div class="alert box-shadow-small radius-small border-main">
								<div class="rightboxtitle">
									<h3><a href="DOMAIN<?php echo url('index/DiaryPage/index',array('id'=>$vo['id'])); ?>" title="<?php echo htmlspecialchars_decode($vo['title']); ?>"><?php echo htmlspecialchars_decode($vo['title']); ?></a></h3></div>
							...
							<h6 class="icon-calendar rightboxtime">&nbsp;<?php echo date("Y-m-d",$vo['add_time']); ?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="DOMAIN<?php echo url('./index/DiaryPage/index',array('id'=>$vo['id'])); ?>"><font onmouseover="this.className='icon-heart'" onmouseout="this.className='icon-heart-o'" class="icon-heart-o"></font></a>&nbsp;<?php echo $vo['flag']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo url('index/DiaryPage/index',array('id'=>$vo['id'])); ?>#comment"><font onmouseover="this.className='icon-comment'" onmouseout="this.className='icon-comment-o'" class="icon-comment-o"></font></a>&nbsp;<?php echo $vo['num_comments']; ?></h6>
							</div>
						</div>
