<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/wwwroot/bilulanlv/application/admin20161108/view/articleadd/index.html";i:1496486037;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<body class="gray-bg">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						...
						<form name="formdata" method="post" onSubmit="return checkpost();">
						<div class="ibox-content">
							...
							<div class="row">
								...
								<div class="col-xs-3  col-md-2" align="left">
									<input type="text" placeholder="引用自/默认原创" name="n_from" class="form-control">
								</div>
								<div class="col-xs-2  col-md-4" align="left">
									<button class="btn btn-md btn-success" onclick="chuan()" type="button">添加文章</button>
		...
		<script language="JavaScript">
			...
			function chuan() {
				...
				$.ajax({
					type:"post",
					url:'<?php echo url('./admin20161108/articleadd/add','','',true); ?>',
