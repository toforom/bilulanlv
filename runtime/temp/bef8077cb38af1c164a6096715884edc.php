<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"/www/wwwroot/bilulanlv/application/index/view/link/index.html";i:1496234963;s:61:"/www/wwwroot/bilulanlv/application/index/view/left/index.html";i:1496223054;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
				...
				<div class="xs5">
						...
						<div class="alert box-shadow-small radius-small border-main">
							...
							<div class="margin-small-top">
								<?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									<a href="<?php echo url('index/Link/click',array('id'=>$vo['id']),''); ?>" target="_blank"><img src="<?php echo $vo['logourl']; ?>" alt="<?php echo $vo['title']; ?>" title="<?php echo $vo['title']; ?>||<?php echo $vo['content']; ?>" width="87px" height="30px" class="margin-little-bottom" /></a>
					...
					<div class="margin-large-top ">
						<div class="alert box-shadow-small radius-small border-main">
							...
							<form name="formdata" class="form-x form-auto" method="post" action="<?php echo url('./index/Link/add',''); ?>" onSubmit="return checkpost();">
