<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/bilulanlv/application/admin20161108/view/link/index.html";i:1496111979;}*/ ?>
<!DOCTYPE html>
<html>
						...
						<div class="ibox-content">
							...
							<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
								<div class="row">
									...
									<form name="formso" method="post" action="<?php echo url('link/search'); ?>" onsubmit="return searcheck();">
								...
								<table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
									...
									<tbody>
										<tr class="gradeA odd">
											...
											<td class=""><a href="<?php echo $vo['url']; ?>" target="_blank"><?php if($vo['logourl'] == ''): ?><?php echo $vo['title']; else: ?><img src="<?php echo $vo['logourl']; ?>" width="88" height="31" /> <?php endif; ?></a></td>
											<td class=""><?php echo date("Y-m-d H:i:s",$vo['add_time']); ?></td>
											<td class=""><a href="<?php echo url('linkchange/index','id='.$vo['id']); ?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-trash" id="<?php echo $vo['id']; ?>" onclick="deleajax(this.id)" style="cursor:pointer;"></span></td>
										</tr>
									</tbody>
...
<script type="text/javascript">
	function deleajax(id){
			...
			//AJAX提交删除
				$.ajax({
					type:"post",
					url:'<?php echo url('./admin20161108/link/del','','',true); ?>',
					data:{id:id},
					datatype:'json',
...
function showajax(id){
		//AJAX提交
				$.ajax({
					type:"post",
					url:'<?php echo url('./admin20161108/link/show','','',true); ?>',
					data:{id:id},
					datatype:'json',
					success:function(data){
						if(data.code==0){
