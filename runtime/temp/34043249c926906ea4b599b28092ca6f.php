<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"/www/wwwroot/bilulanlv/application/index/view/diary_page/index.html";i:1496115012;s:61:"/www/wwwroot/bilulanlv/application/index/view/left/index.html";i:1496223054;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
...
<script src="https://s13.cnzz.com/z_stat.php?id=1262062349&web_id=1262062349" language="JavaScript"></script>
				...
				<div class="xs5 height-big">
					<div class="margin-large-top ">
						<div class="alert box-shadow-small radius-small border-main">
							...
							<p class="text-indent height-big margin-big-top"><?php echo htmlspecialchars_decode($list['content']); ?></p>
							</div>
							<div class="xs6"><p class="text-gray"><span class="text-left">上一篇：<a href="<?php echo url('index/DiaryPage/index',array('id'=>$list['prev'])); ?>"><?php if($list['prev'] == ''): ?>^_^木有了<?php else: ?><?php echo $list['prevtitle']; endif; ?></a></span></p></div>
							<div class="xs6"><p class="text-gray text-right"><span class="text-right">下一篇：<a href="<?php echo url('index/DiaryPage/index',array('id'=>$list['next'])); ?>"><?php if($list['next'] == ''): ?>^_^木有了<?php else: ?><?php echo $list['nexttitle']; endif; ?></a></span></p></div>
		...
		<script language="JavaScript">
			...
			function checkpost() {
				...
				$.ajax({
					type:"post",
					url:'<?php echo url('./index/DiaryPage/comments','','',true); ?>',
					data:$('form[name=formdata]').serialize(),
					datatype:'json',
					beforeSend:function(){
						$('button[id=fbpl]').attr('disabled',true);
						//layer.msg('评论提交中...',{time:10000});
					},
					success:function(data){
						if(data.code==0){
							...
							layer.msg('评论成功，已经发送邮件通知对方。',{time:1500},function(){
								$.ajax({
										type:"post",
										url:'<?php echo url('./index/DiaryPage/DiaryMailComments','','',true); ?>',
