<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"/www/wwwroot/bilulanlv/application/index/view/diary/index.html";i:1496057706;s:61:"/www/wwwroot/bilulanlv/application/index/view/left/index.html";i:1496223054;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
	...
	<!--<div align="center" class="show-l hidden-s hidden-m hidden-b">
	<ul class="daohang"> 
    <li><a href="__APP__/Diary">絮语</a></li> 
    <li><a href="__APP__/Article">文章</a></li> 
    <li><a href="__APP__/Task">任务</a></li> 
    <li><a href="__APP__/Link">朋友</a></li> 
    <li><a href="__APP__/Message">留言</a></li> 
	</ul> 
	</div>-->
						...
						<div class="margin-large-top ">
							<div class="alert box-shadow-small radius-small border-main">
								<div class="rightboxtitle">
									<h3><a href="<?php echo url('index/DiaryPage/index',array('id'=>$vo['id'])); ?>"><?php echo htmlspecialchars_decode($vo['title']); ?></a></h3></div>
