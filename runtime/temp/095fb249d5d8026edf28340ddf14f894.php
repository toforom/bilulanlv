<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/www/wwwroot/bilulanlv/application/admin20161108/view/message/index.html";i:1496111980;}*/ ?>
<!DOCTYPE html>
<html>
						...
						<div class="ibox-content">
							...
							<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline" role="grid">
								<div class="row">
									...
									<form name="formso" method="post" action="<?php echo url('message/search'); ?>" onsubmit="return searcheck();">
								...
								<table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
									<thead>
										<tr role="row">
											<th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 100px;">留言人</th>
											<th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 227px;">留言内容</th>
											<th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 296px;">回复</th>
											<th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 150px;">时间</th>
									...
									<tbody>
										<tr class="gradeA odd">
											...
											<td class=""><span><?php echo $vo['content']; ?></span></td>
											<td class=""><?php if($vo['re_content'] == ''): ?><span lang="<?php echo $vo['email']; ?>,<?php echo $vo['name']; ?>" class="glyphicon glyphicon-pencil" id="<?php echo $vo['id']; ?>" onclick="reajax(this.id,this.lang)" style="cursor:pointer;"></span><?php else: ?><?php echo $vo['re_content']; endif; ?></td>
...
<script type="text/javascript">
	function deleajax(id){
			...
			//AJAX提交删除
				$.ajax({
					type:"post",
					url:'<?php echo url('./admin20161108/message/del','','',true); ?>',
					data:{id:id},
					datatype:'json',
	...
	function reajax(id,lang){
		layer.prompt({title: '回复评论', formType: 2}, function(text){
				...
				$.ajax({
					type:"post",
					url:'<?php echo url('./admin20161108/message/recontent','','',true); ?>',
