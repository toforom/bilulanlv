<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/www/wwwroot/bilulanlv/application/admin20161108/view/diarychange/index.html";i:1496486022;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<body class="gray-bg">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						...
						<form name="formdiary" method="post" action="<?php echo url('diaryadd/add','','',true); ?>" onSubmit="return checkpost();">
						<div class="ibox-content">
							...
							<input type="text" value="<?php echo $vo['title']; ?>" name="title" placeholder="请输入日志标题" class="form-control">
							<br />
							<!--wangedit编辑器-->
							...
							<div class="row" align="center">
								...
								<div class="col-xs-3" align="left">
									<input type="text" name="weather" value="<?php echo $vo['weather']; ?>" placeholder="天气/默认晴" class="form-control">
								</div>
								<div class="col-xs-3" align="left">
									<input type="hidden" value="<?php echo $vo['id']; ?>" name="id">
									<button class="btn btn-md btn-success" onclick="chuan()" type="button" name="submit">修改日志</button>
		...
		<script type="text/javascript">
			...
			function checkpost() {
				if(formdiary.title.value == "") {
					alert("日志标题不能为空！");
					formdiary.title.focus();
					return false;

				}
				if(formdiary.content.value == "") {
					alert("内容不能为空！");
					formdiary.content.focus();
					return false;
			...
			function chuan() {
				...
				$.ajax({
					type:"post",
					url:'<?php echo url('./admin20161108/diarychange/edit','','',true); ?>',
