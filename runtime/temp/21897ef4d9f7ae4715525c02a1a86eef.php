<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"E:\WWW\bilulanlv\public/../application/index\view\index\index.html";i:1497880343;s:65:"E:\WWW\bilulanlv\public/../application/index\view\left\index.html";i:1497880343;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">

	<head>
		<title>深蓝个人博客--记录筚路蓝缕创业生活的个人博客网站！</title>
    ...
    s.parentNode.insertBefore(bp, s);
				...
				<div class="xs5 height-big">
						...
						<div class="margin-large-top ">
							<div class="alert box-shadow-small radius-small border-main">
								<div class="rightboxtitle">
									<h3><a href="<?php if($vo['n_type'] == ''): ?> DOMAIN<?php echo url('index/DiaryPage/index',array('id'=>$vo['id'])); else: ?> <?php echo url('index/ArticlePage/index',array('id'=>$vo['id'])); endif; ?>" title="<?php echo htmlspecialchars_decode($vo['title']); ?>"><?php echo htmlspecialchars_decode($vo['title']); ?></a></h3></div>
					...
					<div align="center" class="margin-big-top">
						<a href="DOMAIN<?php echo url('index/Diary/index'); ?>#bottom" class="button button-block">查看更多</a>
					</div>
